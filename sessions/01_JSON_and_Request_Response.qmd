...
![](images/API-Request-Response.gif){fig-alt="GIF showing API request and response flow between Client, API, Server, and Database"}
...
![](images/Anatomy_of_a_JSON_Response.gif){fig-alt="GIF showing anatomy of a JSON response with body, data, metadata, and status code"}
